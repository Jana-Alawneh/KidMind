        ...
        <section className="parent-account-settings-card parent-account-settings-card-wide">
          <div className="parent-account-settings-card-heading">
            ...
            <div>
              ...
              <p>
                Update your parent account details and profile photo.
              </p>
            </div>
          </div>
          ...
          >
            <div className="parent-account-settings-photo-editor">
              <div className="parent-account-settings-photo-preview">
                {avatar}

                <div className="parent-account-settings-photo-camera">
                  <Camera
                    size={14}
                  />
                </div>
              ...
              <div className="parent-account-settings-photo-copy">
                <strong>
                  Profile Photo
                </strong>
...

                {
                  photoMessage.text
                    ? (
                      <span
                        className={
                          `parent-account-settings-photo-message ${photoMessage.type}`
                        }
                      >
                        {
                          photoMessage.type ===
              ...
              <div className="parent-account-settings-photo-actions">
                <input
                  ref={
                    photoInputRef
                  }
                  ...
                  className="parent-account-settings-photo-input"
                  onChange={
                    handlePhotoSelect
                  }
                  disabled={
                ...
                <button
                  type="button"
                  className="parent-account-settings-photo-upload"
                  onClick={() =>
                    photoInputRef
                      .current
                      ?.click()
                ...
                <button
                  type="button"
                  className="parent-account-settings-photo-remove"
                  onClick={
                    handleRemovePhoto
                  }
                  disabled={
...
const settingsStyles = `
  ...
  .parent-account-settings-photo-editor {
    grid-column: 1 / -1;
    display: flex;
    align-items: center;
    gap: 15px;
  ...
  .parent-account-settings-photo-preview {
    width: 78px;
    height: 78px;
    flex: 0 0 auto;
    position: relative;
    ...
    border-radius: 19px;
    background: linear-gradient(135deg,#dceeff,#e8e0ff);
    color: #557bad;
    box-shadow: 0 9px 24px rgba(81,121,174,.12);
    font-size: 20px;
    font-weight: 850;
  }

  .parent-account-settings-photo-preview > img {
    width: 100%;
    height: 100%;
    display: block;
    object-fit: cover;
  ...
  .parent-account-settings-photo-preview > span {
    display: grid;
    place-items: center;
  }

  .parent-account-settings-photo-camera {
    width: 25px;
    height: 25px;
    position: absolute;
    right: -7px;
  ...
  .parent-account-settings-photo-copy {
    min-width: 0;
    flex: 1;
  }

  .parent-account-settings-photo-copy > strong {
    display: block;
    color: #4d4f68;
    font-size: 11px;
  }

  .parent-account-settings-photo-copy > span {
    display: block;
    max-width: 430px;
    margin-top: 5px;
    color: #9a9cad;
  ...
  .parent-account-settings-photo-copy > small {
    display: block;
    max-width: 430px;
    margin-top: 6px;
    overflow: hidden;
  ...
  .parent-account-settings-photo-message {
  ...
  .parent-account-settings-photo-message.success {
    color: #4f8b69 !important;
  }

  .parent-account-settings-photo-message.error {
    color: #b85d67 !important;
  }

  .parent-account-settings-photo-actions {
    flex: 0 0 auto;
    display: flex;
    align-items: center;
    gap: 8px;
  ...
  .parent-account-settings-photo-input {
    display: none;
  }

  .parent-account-settings-photo-upload,
  .parent-account-settings-photo-remove {
    min-height: 36px;
    display: inline-flex;
    align-items: center;
    justify-content: center;
  ...
  .parent-account-settings-photo-upload:disabled,
  .parent-account-settings-photo-remove:disabled {
    opacity: .5;
    cursor: not-allowed;
  }
  ...
  html[data-kidmind-appearance="dark"] .parent-account-settings-photo-editor {
    border-color: #393b50;
    background:
      linear-gradient(
        135deg,
  ...
  html[data-kidmind-appearance="dark"] .parent-account-settings-photo-preview {
    border-color: #37394b;
  }

  html[data-kidmind-appearance="dark"] .parent-account-settings-photo-camera {
    border-color: #292b3d;
  }

  html[data-kidmind-appearance="dark"] .parent-account-settings-photo-copy > strong {
    color: #ececf5;
  }

  html[data-kidmind-appearance="dark"] .parent-account-settings-photo-copy > span,
  html[data-kidmind-appearance="dark"] .parent-account-settings-photo-copy > small {
    color: #a6a8bb;
  }

  html[data-kidmind-appearance="dark"] .parent-account-settings-photo-upload {
    border-color: #3e536b;
    background: #29384a;
    color: #b9d8f7;
  }

  html[data-kidmind-appearance="dark"] .parent-account-settings-photo-remove {
    border-color: #5d3c45;
    background: #3b2d33;
    color: #e3a5ad;
  }
